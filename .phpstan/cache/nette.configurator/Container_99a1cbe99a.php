...
class Container_99a1cbe99a extends _PHPStan_bc6352b8e\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_99a1cbe99a $container)
			{
	...
	public function createServiceContainer(): Container_99a1cbe99a
	{
		return $this;
	}
